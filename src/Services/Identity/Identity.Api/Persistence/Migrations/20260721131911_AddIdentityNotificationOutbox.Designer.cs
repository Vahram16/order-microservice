...
namespace Identity.Api.Persistence.Migrations
{
    ...
    [Migration("20260721131911_AddIdentityNotificationOutbox")]
    partial class AddIdentityNotificationOutbox
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Identity.Api.Notifications.IdentityNotificationOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProcessedAtUtc", "DeadLetteredAtUtc", "AvailableAtUtc", "LockedUntilUtc");

                    b.ToTable("notification_outbox", "identity");
                });
