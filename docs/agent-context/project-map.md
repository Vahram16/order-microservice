...
| Payment behavior, saved payment methods, provider integration | `src/Services/Payment` | `services/payment.md` |
...
- If the task names Payment or modifies files under `src/Services/Payment`, load `services/payment.md`.
